...
######Option 3:
If you don't like to type commands, you can use the [PlantGeIE extract intron feature tool](http://galaxy.popgenie.org:8080/tool_runner?tool_id=extract_intron_gff3). Final result similar to [this](http://galaxy.popgenie.org:8080/u/chanaka/h/extract-intron-gff3)
